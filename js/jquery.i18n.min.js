...
jQuery(document).ready(function() {
    ...
    //let currLan = $.cookie('curr_lan') ? $.cookie('curr_lan') : 'zh';
    
	//$.cookie('curr_lan') ? loadBundles($.cookie('curr_lan')) : loadBundles('zh');

    let currLan = getCookie('curr_lan') ? getCookie('curr_lan') : 'zh';

    if(currLan == 'en'){
            if(window.location.pathname.indexOf('help.html') !== -1 || window.location.pathname.indexOf('how-to-use-scatter.html') !== -1 || window.location.pathname.indexOf('about-us.html') !== -1){
                window.location.href = window.location.href.replace(/\.html/,'-en.html')
                throw new Error('location to en')
            }

            $('#my-navbar-dropdown li a').each(function(){
                if($(this).attr('href')){
                    if(($(this).attr('href').indexOf('help.html') !== -1  || $(this).attr('href').indexOf('about-us.html') !== -1)){
                        $(this).attr('href',$(this).attr('href').replace(/\.html/,'-en.html'))
                    }
                }
            })

            $('.panel-default li a').each(function(){
                if($(this).attr('href')){
                    if(($(this).attr('href').indexOf('help.html') !== -1  || $(this).attr('href').indexOf('about-us.html') !== -1) || $(this).attr('href').indexOf('how-to-use-scatter.html') !== -1){
                        $(this).attr('href',$(this).attr('href').replace(/\.html/,'-en.html'))
                    }
                }
            })
        ...
        if(window.location.pathname.indexOf('help-en.html') !== -1 || window.location.pathname.indexOf('how-to-use-scatter-en.html') !== -1 || window.location.pathname.indexOf('about-us-en.html') !== -1){
            window.location.href = window.location.href.replace(/-en\.html/,'.html')
            throw new Error('location to zh')
        }
    }
            ...
            if($(this).attr('placeholder')){
                try{
            	   $(this).attr('placeholder', $.i18n.prop($(this).attr('fy')))
                    ...
                    console.log('exception when trans:' + $(this).attr('fy'))
                }
            }else{
